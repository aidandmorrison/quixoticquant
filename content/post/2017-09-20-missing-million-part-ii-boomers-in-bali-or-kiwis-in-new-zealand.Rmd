...
```{r, warning=FALSE, message= FALSE, fig.align="center", fig.cap="Relatively long 'Short-Term' Arrivals have the largest contribution to persons absent"}
# Impact of Departures by Time
plot <- sheet_340106 %>% 
  ggplot(aes(x = Date, text = as_date(Date)))+
  geom_line(aes(y = Num.of.mov.2.wee.and.und.1.mon.Pre.12m*22/365, col = "2 weeks to a month"))+
