...
Next is the 'Gross overcount for people on Census forms'.  This one is for people who are included on multiple forms, or multiple times over by error, which amounted to 302,194 last Census.  Those two numbers net out to a 'Net undercount for people on Census forms', or 716,581 people, or 3.0% of population.
...
If any more evidence was required to support the idea that the the Census could quite easily have errors of several hundred thousand, another curious comment in Appendix B of the 2016 report threw another lazy fact into the mix that zoomed out to expose yet another level of uncertainty:
