...
I mightn't have ever noticed, if I hadn't attempted to reproduce two columns called 'Arrivals' and 'Departures' from numbers in two spreadsheets called 'Arrivals' and 'Departures'.  That's right, the ABS keeps these series in separate places, with different catalogue numbers (310101, 340101, 340102), with different date ranges, and frequencies of data recorded, seemingly for no other reason than to throw a moat their data to fend off amateur analysts attempting to assault the ABS's credibility.  

Naturally I failed.  I wanted to assume that some simple addition of the Permanent and Long Term Arrivals would produce the 3101 Arrivals, and same with Departures, and the net of those would produce (or at least closely follow) the hallowed NOM.  Please enjoy chuckling at my niaivity.  Infact the net Permanent and Long Term movements give a trend that's far higher than Net Overseas Migration.   The Net Short Term movements, on the other hand, used to be trivial, but had in recent decades had become quite large and negative.
...
I'm not sure whether I should thank the ABS for spelling out so clearly how to treat data points that are observations of an different thing.  "Not comparable" are suitable words for anyone who might have tried to avoid the unavoidable conclusion about such a substantial change in method.  But overall I think my gratitude for spelling out the obvious is overwhelmed by my dismay a their burying this insight in paragraph 23 of the 'Explanatory Notes' tab, where only the most determined and tireless of data consumers are likely to encouter it.  

On the excel spreadsheet, or on the downloads tab where you download them there is absolutely no warning, flag, note, colour change, column change, or anything else at all could indicate that the series in numbers past a certain point down the sheet are 'not comparable' with the ones above it. So with almost no exceptions users tend to string it together on one axis, in sequence, in one line weight, in one colour, blithely ignorant of the fact that they're plotting two different bits of data which are "not comparable" according to the producer of the data.  So now Australia is used to consuming graphs that have the integrity of porridge.  Literally, the kind of slop which hung-over first-year uni students cobble together on the bus on the way to a turorial which requires attendance but doesn't grade exercises.  If they do it in assignments, they fail.  It's gobsmacking to realise that all of Australia's leading economists are doing it relentlessly, if accidentally.
...
```
This presentation gets an 'A' for data visualisation in your quantiative methods course.  It asks the proper important question: Why does the ABS not have a longer data series on immigration? (Spoiler alert: it does, it's just not giving it to us.)
...
![Productivity Commission, April 2016](images/Screen Shot 2017-08-25 at 9.46.11 am.png){ width=50% }
...
![Exctract from KPMG Immigration Infographic](images/Screen Shot 2017-08-25 at 11.05.33 am.png)
...
The striking thing here is that the two series had indeed departed, but in the opposite way that one might suspect.  The grey bars represent the cumulative difference between the two series, which would be represent the discrepancy between how many people we recorded as 'resident', and the number of people acutally physically here.  They track very nicely together up until about 2001, when a substantial gap opens up.  But this gap actually represents Net Overseas Migration _over estimating_ the the actual net change in people present in Australia.  

To simplify and stereotype, the new migrants who flew home for Christmas and never officialls 'arrived' according to the 12/12 rule were starting to be heavily outweighed by the Australian expats who flew back every Christmas, and never 'departed'.  And with the 'physically present population' now a hefty quarter of a million people smaller than what the official 'Estimated Residient Population' recorded in 3101, it seemed neccessary to shift the definition to maintain the credibility of the series, which previously had done a decent job of reflecting actual changes in the population.

So by shifting the definition of what consitituted an 'arrival' or 'departure' for migration purposes to include 
any movement that was followed by a _cumulative_ total of 12 months spent in or out of Australia (including multiple trips) the ABS hoped that the anomalous buildup of expats who had never 'left' because they came home for Christmas might be evened out.
...
Arguably it might have helped, for a moment, to at least stemmed the explosion of the discrepancy between the two series.  But in truth the new definition change would needed peoples travel habits to stabilise.  Travel growth did stall for a moment, at the peak of the Global Financial Crisis when the Aussie Dollar plumetted, as you can see from this graph smoothing out net movements over 12 months.  
...
But afterwards in accelerated again with new vigour, and the gulf between net movements and official 'Net Overseas Migration' opened wider than ever before.  Or even if ABS was catching the expats who came home for Christmas, they were being rapidly overwhelmed by the droves of people spending months in the year away for all sorts of exchanges, holidays, business trips, secondments, backpacking, GAP years, conferences, family visits etc, but still managing to clock up more than four months in any given 16 back in Aus.
...
So what's the upshot of the ABS persisting in using the aribrarty and inadequate definition of Net Overseas Migration? Simply that no-one is keeping track of a far more reliable, rigorous, and consistently defined alternative: Net Overseas Movements.  Guessing about what people's travel plans and intentions are, where they're really likely to be, on average in the medium to long term always, and whether that adequantly constitutes 'migration' is really just a vain attempt at creating a code for rigorous tea-leaf reading.  It's necessarily arbitraty, and conctinually subject to the tides of change in human behaviour.

On the other hand, being an island nation makes the act of crossing a border one of the easiest, most clear-cut, comprehensively collected statistics that we could ever hope to encounter.  Unless we believe that thousands of people are leaping paste the customs gates at airports, or that the thousands of boat people land on our shores (and integrate into society) completely unnoticed, or that every trade-ship is packed full of stow-aways, then movement numbers collected by our border authorities should be about as hard and fast as statistics can come.  And unlike almost every other stat collected by ABS, we actually measure every one of them, not just imputing from a sample survey.

And if we take Net Overseas Movements as metric for migration, a very different story about migration rates in Australia.
...
It's easy to see how people would still attain the impression that Net Migration has increased.  Taking a linear trend you would assume that the we've risen from an average migration rate of under half a percent to nearly one percent of population.
...
No, your eyes aren't deceiving you, that's actually a slight downward slope.  It's a volatile, cyclic series that is essentially unchanged in terms of level over nearly 40 years, if there's any trend at all it's probably slightly downwards.
...
As always statistics need to be interpreted with care.  Sure, an investor who spends little time here can push up property prices. But the moment someone starts claiming that immigrants are congesting our roads and we should cut immigration because our infrastructure can't keep up with their rate of arrival, (see Cory Bernardi and Mark Latham [here](https://www.youtube.com/watch?v=28ZO4BXRq-Q)) it's time to grip your sides and start rolling around in the aisles in laughter.  People who are overseas don't drive their cars on the M5 in Sydney.
