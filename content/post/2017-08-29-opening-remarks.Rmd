...
I think it’s worth a short post to explain where the name ‘Quixotic Quant’ came from, and why I’ve
chosen it for this blog.
The short version is that it’s a neat way of capturing a simple juxtaposition this blog seeks to
embrace:
1. A high standard of rigour, objectivity, transparency to the quantitative analysis
2. A style that’s intellectually combative, provocative, and accessible and entertaining to a
broad audience
